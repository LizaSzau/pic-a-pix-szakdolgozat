...
$sql = "SELECT a.kocka_x, a.kocka_y, b.pix FROM pix AS a, pix_save AS b WHERE a.id = $id AND b.id_pix = a.id";
$vissza = mySQL_query($sql);
$sor = mySQL_fetch_array($vissza);

$x = $sor[0];
$y = $sor[1];
$pix = explode(",", substr($sor[2], 1));
...
//$szinek[0] = imagecolorallocate($im, 255, 255, 255);
